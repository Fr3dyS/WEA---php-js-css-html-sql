...
<body>
	<form method="post" id="fg" action="login.php">
		...
		<div class="form-group">
			<input type="text" class="form-control" name="jmeno" required="required" placeholder="Vloz jmeno">
		</div>
		<div class="form-group">
			<input type="password" class="form-control" name="heslo" required="required" placeholder="Vloz heslo">
		</div>
