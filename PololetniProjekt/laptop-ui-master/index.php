	...
	<main>
		...
		<section class="presentation" onclick="swapDiv(event,this);">
			<div class="introduction">
				...
				<div class="cta">
					<a class="cta-select" href="#">do minulosti</a>
				</div>
			</div>
			<div class="slideshow-container">
				...
				<div class="mySlides fade">
					<img src="./img/vectron_RJ.JPG" style="width:100%">
				</div>

				<div class="mySlides fade">
					<img src="./img/vectron.JPG" style="width:100%">
				</div>
				<div class="autor"><strong>autor fotek: </strong> Samuel Kovár</div>
		...
		<section class="presentation" onclick="swapDiv(event,this);">
			<div class="introduction">
				<div class="intro-text">
					...
					<p>vlaky pouze z české republiky do 20. století</p>
				</div>
				<div class="cta">
					<a class="cta-select" href="#">do součastnosti</a>
				</div>
			</div>
			<div class="slideshow-container">

				<div class="mySlides fade">
					<img src="./img/para1.JPG" style="width:100%">
				</div>

				<div class="mySlides fade">
					<img src="./img/para2.JPG" style="width:100%">
				</div>
				...
				<div style="text-align:center">
					<span class="dot" onclick="aktualniSlide(1)"></span>
					<span class="dot" onclick="aktualniSlide(2)"></span>
					<span class="dot" onclick="aktualniSlide(3)"></span>
				</div>
